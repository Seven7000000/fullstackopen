...
const diagnoses: Diagnosis[] = [
  ...
  },
  {
    ...
    latin:
      'Distorsio et/sive distensio articulationum et/sive ligamentorum capitis partium aliarum et/sive non specificatarum',
  },
  {
    code: 'J10.1',
    name: 'Influenza with other respiratory manifestations, other influenza virus identified',
    latin:
      'Influenza cum aliis manifestationibus respiratoriis, virus influenzae identificatum',
  },
  {
    code: 'J06.9',
  ...
  },
  {
    ...
    latin: 'Retinopathia proliferativa alia',
  },
];
